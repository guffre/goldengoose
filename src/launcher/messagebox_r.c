...
__declspec(dllexport) ULONG_PTR ReflectiveLoader( LPVOID lpAddr) {
...
BOOL WINAPI DllMain(HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpReserved)
{
    ...
    switch (fdwReason)
    {
        case DLL_PROCESS_ATTACH:
            MessageBox(NULL, "DLL Loaded! attach", "DLL Loaded!", MB_ICONINFORMATION);
            // DLL is being loaded
            if( lpReserved != NULL )
            {
        ...
        case DLL_PROCESS_DETACH:
            MessageBox(NULL, "DLL Loaded! detach", "DLL Loaded!", MB_ICONINFORMATION);
            // DLL is being unloaded
            break;
        case DLL_THREAD_ATTACH:
            MessageBox(NULL, "DLL Loaded! thread attach", "DLL Loaded!", MB_ICONINFORMATION);
            // A new thread is being created in the process
            break;
        case DLL_THREAD_DETACH:
            MessageBox(NULL, "DLL Loaded! thread detach", "DLL Loaded!", MB_ICONINFORMATION);
